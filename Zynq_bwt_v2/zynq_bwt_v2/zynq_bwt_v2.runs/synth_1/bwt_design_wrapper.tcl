...
synth_design -top bwt_design_wrapper -part xc7z020clg484-1


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef bwt_design_wrapper.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file bwt_design_wrapper_utilization_synth.rpt -pb bwt_design_wrapper_utilization_synth.pb"
