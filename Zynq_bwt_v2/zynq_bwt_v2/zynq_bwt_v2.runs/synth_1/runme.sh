...
HD_PWD='D:/MTM/semestr8/SDUP_BWT/BWT_3/BWT/Zynq_bwt_v2/zynq_bwt_v2/zynq_bwt_v2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bwt_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bwt_design_wrapper.tcl
