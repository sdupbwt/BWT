...
HD_PWD='D:/MTM/semestr8/SDUP_BWT/BWT/src/ip/edit_bwt_axis_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bwt_axis_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bwt_axis_v1_0.tcl
